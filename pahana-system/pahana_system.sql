...
--
-- Host: 127.0.0.1    Database: pahana_system
-- ------------------------------------------------------
...
CREATE TABLE `bills` (
  ...
  CONSTRAINT `bills_ibfk_2` FOREIGN KEY (`generated_by`) REFERENCES `users` (`username`)
...
CREATE TABLE `users` (
  ...
  `hashed_pwd` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dump completed on 2025-08-06 18:01:04
